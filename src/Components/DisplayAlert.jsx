...
export const AlertBox = () => {
  ...
  return (
    <div className="">
      <div
        className="absolute w-2/4 lg:w-1/3 top-5 left-1/4 lg:left-1/3 fixed animate-bounce  "
      ...
      >
        ...
        {error.status == "message" && (
          <div
            className="bg-voilet-100 border-t-4 border-voilet-500 rounded-b text-voilet-900 px-4 py-3 shadow-md"
            role="alert"
          >
            <div className="flex">
              <div className="py-1">
